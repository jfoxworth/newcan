			...
			<div class="content-wrap">
				...
				<div class="container clearfix">
					...
					<div class="col nobottommargin">
						...
						<p>By filling out the form below, you will make yourself available to be contacted through email or phone by candidates that are running on our core issues. You also let us count you as someone who shares our views when we discuss issues with representatives. (No personal info is shared)</p>
						...
						<form id="register-form" name="register-form" class="nobottommargin" action="#" method="post">
							...
							<div class="col_half col_last">
								...
								<select id="register-form-state" name="register-form-state" value="" class="form-control">
					...
					<div class="col_one_fourth col_last nobottommargin"></div>
